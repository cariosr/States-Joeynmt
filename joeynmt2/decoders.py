...
class Decoder(nn.Module):
    ...
    def DQN_layer(self):
        """
        Return the DQN_layer of the decoder

        :return:
        """
        return self._DQN_layer
...
class RecurrentDecoder(Decoder):
    ...
    def __init__(self,
        ...
        if self.DQN_mode:
            print ("DQN_mode: ",self.DQN_mode)
            self._DQN_layer = DQNLayer(hidden_size, vocab_size)
        else:
    ...
    def forward(self,
        ...
        if self.DQN_mode:
            outputs = self._DQN_layer(att_vectors)
        else:
